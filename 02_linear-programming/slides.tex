...
\input{models/crude-distillation.tex}
\input{models/diet-problem.tex}
...
\input{examples/example_fluid-blending_gupta}  % example 2.6-10 Gupta
\input{examples/example_production-planning02_gupta}  % example 2.6-11 Production Planning Problem Gupta
\input{examples/example_transportation_gupta}  % example 2.6-12
\input{examples/example_product-mix03_gupta}  % example 2.6-13 Gupta Ebook
\input{examples/example_product-mix04_gupta}
\input{examples/example_product-mix05_gupta}
\input{examples/example_product-mix06_gupta}
\input{examples/example_product-mix07_gupta}
\input{examples/example_2-06-18.tex}
...
\input{activities/act_reddy-mikks01_taha}
\input{activities/act_taha-02-02A-04.tex}
\input{activities/act_taha-02-02A-05.tex}
\input{activities/act_taha-02-02A-06.tex}
