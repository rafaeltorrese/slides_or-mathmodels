...
\input{examples/example_production-planning02_gupta}
\input{examples/example_transportation_gupta}
\input{examples/example_product-mix03_gupta}
...
\input{activities/act_reddy-mikks02_taha}
