...
\begin{block}<only@4>{Step 4. Iterate Towards An Optimal Solution.} \justifying
  ...
  $c_j - Z_j$ is either positive or zero under all columns, an optimal basic feasible solution to hte auxiliary L.P.P. has been obtained.
